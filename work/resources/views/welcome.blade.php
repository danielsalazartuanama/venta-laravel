                        ...
                        <div class="feature-category-carousel-wrapper">
                            <div class="featured-carousel-active slick-padding slick-arrow-style arrow-space">
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-s-6.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-s-5.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                        </div>
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-s-2.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-s-3.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                        </div>
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-s-4.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-s-6.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                        ...
                        <div class="feature-category-carousel-wrapper">
                            <div class="featured-carousel-active slick-padding slick-arrow-style">
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-f-2.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-f-4.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-f-4.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-f-2.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-f-2.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-f-3.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                        </div>
                        ...
                        <div class="feature-category-carousel-wrapper">
                            <div class="featured-carousel-active slick-padding slick-arrow-style">
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-b-2.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-b-4.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                        </div>
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-f-3.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-s-1.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                        </div>
                                ...
                                <div class="product-item fix">
                                    <div class="product-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('galio/assets/img/product/product-b-2.jpg')}}" class="img-pri" alt="">
                                            <img src="{{asset('galio/assets/img/product/product-b-3.jpg')}}" class="img-sec" alt="">
                                        </a>
                                        <div class="product-label">
                                            <span>hot</span>
                                        </div>
                    ...
                    <div class="category-carousel-active row" data-row="2">
                        ...
                        <div class="col">
                            <div class="category-item">
                                <div class="category-thumb">
                                    <a href="product-details.html">
                                        <img src="{{asset('galio/assets/img/product/product-f-3.jpg')}}mg/product/product-f-3.jpg" alt="">
                                    </a>
                                </div>
                                <div class="category-content">
